...
public abstract class Configurations<G, W> {
    ...
    protected ObjectMapper.Factory.Builder createObjectMapper() {
        return ObjectMapper.factoryBuilder()
            ...
            .addConstraint(Constraints.Max.class, Number.class, new Constraints.Max.Factory()); // Stellar - add maximum range constraint
    }
    ...
    public static <T> CheckedFunction<ConfigurationNode, T, SerializationException> reloader(Class<T> type, T instance) { // Stellar - package-private -> public
        return node -> {
