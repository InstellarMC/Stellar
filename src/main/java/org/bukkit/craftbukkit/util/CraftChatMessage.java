    ...
    private static final class StringMessage {
        ...
        private StringMessage(String message, boolean keepNewlines, boolean plain) {
            ...
            while (matcher.find()) {
                ...
                switch (groupId) {
                case 1:
                    char c = match.toLowerCase(java.util.Locale.ROOT).charAt(1);
                    ...
                    if (c == 'x') {
                        ...
                        if (this.hex.length() == 7) {
                            this.modifier = StringMessage.RESET.withColor(TextColor.parseColor(this.hex.toString()).result().orElse(null));
                            this.hex = null;
                        }
