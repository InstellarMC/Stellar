...
import com.destroystokyo.paper.profile.SharedPlayerProfile;import com.google.common.collect.ImmutableMap.Builder;
...
class CraftMetaSkull extends CraftMetaItem implements SkullMeta {
    ...
    public void setOwnerProfile(PlayerProfile profile) {
        if (profile instanceof final SharedPlayerProfile sharedProfile) {
