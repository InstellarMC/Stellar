...
public class Main {
    public static final java.time.Instant BOOT_TIME = java.time.Instant.now(); // Paper - track initial start time // Stellar - See net.minecraft.server.Main#main for boot time tracking
