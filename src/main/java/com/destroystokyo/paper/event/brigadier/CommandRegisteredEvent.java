...
public class CommandRegisteredEvent<S extends io.papermc.paper.brigadier.BukkitBrigadierCommandSource> extends ServerEvent implements Cancellable {

    private static final HandlerList handlers = new HandlerList();
    private final String commandLabel;
    private final Command command;
    private final io.papermc.paper.brigadier.BukkitBrigadierCommand<S> brigadierCommand;
    ...
    public CommandRegisteredEvent(String commandLabel, io.papermc.paper.brigadier.BukkitBrigadierCommand<S> brigadierCommand, Command command, RootCommandNode<S> root, LiteralCommandNode<S> literal, ArgumentCommandNode<S, String> defaultArgs) {
